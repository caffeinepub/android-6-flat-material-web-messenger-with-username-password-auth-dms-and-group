...
export class Backend implements backendInterface {
    ...
    async addParticipant(arg0: string, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addParticipant(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createGroupChat(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createGroupChat(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDirectMessages(arg0: Principal): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async getGroupMessages(arg0: string): Promise<Array<Message>> {
        if (this.processError) {
            try {
